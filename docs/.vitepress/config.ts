        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Rich chat replies', link: '/shmastra/features/rich-chat' },
            {
              ...
              link: '/shmastra/features/connecting-channels',
              collapsed: true,
              items: [
                { text: 'Discord', link: '/shmastra/features/channel-discord' },
                { text: 'Email (Resend)', link: '/shmastra/features/channel-email' },
                { text: 'GitHub', link: '/shmastra/features/channel-github' },
                { text: 'Google Chat', link: '/shmastra/features/channel-google-chat' },
                { text: 'Linear', link: '/shmastra/features/channel-linear' },
                { text: 'Liveblocks', link: '/shmastra/features/channel-liveblocks' },
                { text: 'Mattermost', link: '/shmastra/features/channel-mattermost' },
                ...
                { text: 'Webex', link: '/shmastra/features/channel-webex' },
                { text: 'WhatsApp', link: '/shmastra/features/channel-whatsapp' },
                { text: 'Zalo', link: '/shmastra/features/channel-zalo' },
                { text: 'Zernio (social DMs)', link: '/shmastra/features/channel-zernio' },
              ],
            },
